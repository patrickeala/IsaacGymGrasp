...
class IsaacGymSim:
    def __init__(self, args, headless):
        ...
        self.friction_coefficient = 0.5 # 0.1 for box mug cylinder bottle  for bowl should be more than 0.2, need to test more
        # if args.cat == "bowl":
        #     self.friction_coefficient = 0.2
        # elif args.cat == "scissor":
    ...
    def set_obj_asset_options(self):
        ...
        obj_asset_options.vhacd_params.resolution = 64000000 #10,000-64,000,000.
